    ...
    <>
      <section>
        <div className="">
          ...
          <div>
            <div>
              <div className="max-w-[1440px] mx-auto px-[5%] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white border p-5 shadow-md rounded-lg overflow-hidden">
                  ...
                  />
                  <div className="mt-4">
                    <h3 className="text-xl font-Mon font-semibold">
                      Event Title 1
                    </h3>
                    <p className="text-gray-600 mt-1">
                      Event description goes here. It provides a brief overview
                      of the event.
                    </p>
                    <p>Location: </p>
                    <p>Time:</p>
